		...
		foreach ( $this->_meta_box['fields'] as $field ) {
			...
			switch ( $field['type'] ) {
				...
				case 'portfolio':
						...
						if( $portfolio_slider ) {
							foreach ( $portfolio_slider as $i => $slide ) {
								...
								$html .= '<li class="slide postbox">
											<div class="handlediv" title="' . __('Click to toggle', 'liquidfolio') . '">&nbsp;</div>
											<h3 class="hndle"><span>' . __('Slide', 'liquidfolio') . '</span></h3>
											<div class="inside">
												<div>
														...
														<div class="slide-type image">
															<div class="ox-field">
																<div class="image-label">
																	<label>' . __('Image URL', 'liquidfolio') . '</label>
																</div>
																<div class="meta-image-input">
																	<input type="text" name="slide-img-src[]" size="30" value="' . $slide_img_src . '">
																	<input type="button" name="upload-image" class="upload-image" value="' . __('Upload Image', 'liquidfolio') . '">
																</div>
															</div>
														</div>
													</div>
												...
												<div>
												<button class="remove-slide button-secondary">' . __('Remove Slide', 'liquidfolio') . '</button>													
						...
						$html .= '</ul>
								  <div class="image-label">
									<p><br><button id="add-slider-slide" class="button-primary">' . __('Add New Slide', 'liquidfolio') . '</button></p>
								  </div>
								  <div class="meta-image-input">
					...
					case 'video_url':
						echo '<input type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" />','<p class="cmb_metabox_description">', $field['desc'], '</p>';
						echo '<button class="upload_video button">' . __('Upload Video', 'liquidfolio') . '</button>';
						break;
					case 'audio_url':
						echo '<input type="text" name="', $field['id'], '" id="', $field['id'], '" value="', '' !== $meta ? $meta : $field['std'], '" />','<p class="cmb_metabox_description">', $field['desc'], '</p>';
						echo '<button class="upload_audio button">' . __('Upload Audio', 'liquidfolio') . '</button>';
						break;
				default:
