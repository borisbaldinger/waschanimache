...
<title><?php _e('Contact form','liquidfolio'); ?></title>
...
<script type="text/javascript">
	...
	var ajax_nonce_shortcode = '<?php echo wp_create_nonce( 'qd_contactform_shortcode' ); ?>';
	var ajax_nonce_json = '<?php echo wp_create_nonce( 'qd_contactform_shortcode_to_json' ); ?>';
</script>
...
<body  onload="init();">
	<div id="media-upload-header">
		<div id="fb-success" class="fb-success" style="display: none;"><?php _e('Your new field was saved successfully','liquidfolio'); ?></div>

	</div>
	<div class="fb-right">
	
		<div id="fb-add-field" style="display: none;">
			<h3><?php _e('Edit this new field','liquidfolio'); ?></h3>
			
			<label for="fb-new-label"><?php _e('Label','liquidfolio'); ?></label>
			<input type="text" id="fb-new-label" value="<?php _e('New field','liquidfolio'); ?>" />
			
			<label for="fb-new-label"><?php _e('Field type','liquidfolio'); ?></label>
			<select id="fb-new-type">
				<option value="checkbox"><?php _e('Checkbox','liquidfolio'); ?></option>
				<option value="select"><?php _e('Drop down','liquidfolio'); ?></option>
				<option value="email"><?php _e('Email','liquidfolio'); ?></option>
				<option value="name"><?php _e('Name','liquidfolio'); ?></option>
				<option value="radio"><?php _e('Radio','liquidfolio'); ?></option>
				<option value="text" selected="selected"><?php _e('Text','liquidfolio'); ?></option>
				<option value="textarea"><?php _e('Textarea','liquidfolio'); ?></option>
				<option value="url"><?php _e('Website','liquidfolio'); ?></option>
			</select>
			<div class="clear"></div>
			
			<div id="fb-options" style="display: none;">
				<div id="fb-new-options">
					<label for="fb-option0"><?php _e('Options','liquidfolio'); ?></label>
					<input type="text" id="fb-option0" optionid="0" value="<?php _e('First option','liquidfolio'); ?>" class="fb-options" />
				</div>
				<div id="fb-add-option" class="fb-add-option">
					<a href="#" id="fb-another-option"><?php _e('Add another option','liquidfolio'); ?></a>
				</div>
			</div>
			...
			<div class="fb-required">
				...
				<label for="fb-new-label" class="fb-radio-label"><?php _e('Required?','liquidfolio'); ?></label>
				<div class="clear"></div>
			</div>
			<div id="fb-reply" style="display: none;">
				<label for="fb-new-label"></label>
				<input type="checkbox" id="fb-new-reply" />
				<label for="fb-new-label" class="fb-radio-label"><?php _e('Use for reply?','liquidfolio'); ?></label>
				<div class="clear"></div>
			</div>
			
			<input type="hidden" id="fb-field-id" />
			<input type="submit" class="button" value="<?php _e('Save this field','liquidfolio'); ?>" id="fb-save-field" name="save">
		</div>
	</div>
	<form id="fb-preview">
		<div id="fb-add-field" class="fb-container" style="float:left">
			<h1><?php _e("Here's what your form will look like","liquidfolio"); ?></h1>
			<div id="sortable" class="fb-form-case">
				
				<div id="fb-extra-fields" class="fb-extra-fields"></div>
				
				<a href="#" id="fb-new-field" class="fb-add-field"><?php _e('Add a new field','liquidfolio'); ?></a>
			</div>
			...
			<input type="submit" class="button-primary" tabindex="4" value="<?php _e('Add this form to my post','liquidfolio'); ?>" id="fb-save-form" name="save">
		</div>
		<div id="fb-email-settings" class="fb-container" style="float: left;">
			<h1><?php _e('Email settings','liquidfolio'); ?></h1>
			<div class="fb-form-case fb-settings">
				<label for="fb-fieldname"><?php _e('Enter your email address','liquidfolio'); ?></label>
				<input type="text" id="fb-field-my-email" style="background: #FFF !important;" />

				<label for="fb-fieldemail" style="margin-top: 14px;"><?php _e('What should the subject line be?','liquidfolio'); ?></label>
