...
//	}
	...
	public function renderPage()
	{
		...
		if($this->getMenuSlug() != SHORTNAME.'_dummy')
		{
			...
			$html .= '<input name="save_options" type="submit" value="Save Changes" class="lf_save"  />'.
				$save_nonce	
				.'</form>
			<form method="post" id="lf_reset"  action="">'.
				$reset_nonce
				.'<input name="reset_options" type="submit" value="Reset" class="lf_reset" />
