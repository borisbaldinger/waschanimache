...
class Widget_Gallery extends Widget_Default implements Widget_Interface_Cache
{
	...
	function form( $instance ) {
		...
		// Defaults
		$gallery_terms = '';
		$defaults = array( 'title' => __( 'From gallery', 'liquidfolio' ), 'number' => '4');
		...
		<div>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'category' ); ?>" >
					<?php _e( 'Category of gallery:', 'liquidfolio' ); ?>
				</label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of items to show:', 'liquidfolio' ); ?></label>
