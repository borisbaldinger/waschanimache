...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		showLoading: function () {
			...
			el = $('div').is('#fancybox-loading') ? $('#fancybox-loading') : $('<div id="fancybox-loading"><div></div></div>').appendTo('body');
			el.click(F.cancel);
	...
	F.helpers.overlay = {
		...
		create : function(opts) {
			...
			this.overlay = $('div').is('.fancybox-overlay') ? $('.fancybox-overlay') : $('<div class="fancybox-overlay"></div>').appendTo( 'body' );
			this.fixed   = false;
