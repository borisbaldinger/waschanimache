...
$route['(content|albums)/featured(/(:any))?'] = "features/index/model:$1/$2";
$route['features/(content|album)s?(/(:any))?'] = "features/index/model:$1$2";
$route['albums/([a-z0-9]+)/(content|covers)(/(.*))?'] = "albums/$2/$1/$3";
$route['albums/tree(:any)?'] = "albums/tree$1";
$route['albums/(:any)'] = "albums/index/$1";
$route['galleries/([0-9]+)/albums(/(.*))?'] = "galleries/albums/$1/$2";
$route['galleries/(:any)'] = "galleries/index/$1";
$route['content(/(.*))?'] = "contents/index/$1";
$route['categories/([0-9]+)/(content|albums|essays)(/(.*))?'] = "categories/members/$2:true/$1/$3";
